...
export class ChannelService {
    ...
    constructor(
        ...
        this.hubProxy.on('onEvent', (channel: string, ev: ChannelEvent) => {
            ...
            // this.messageReceived.emit(ev.Data.Ask);
            // this.ask = ev.Data.Ask;
            // console.log('spot:' + ev.Data.Ask);
            // this.SpotData = ev.Data;
    ...
    // unuse
    unsub(channel: string): Observable<ChannelEvent> {
        let channelSub = this.subjects.find((x: ChannelSubject) => {
            return x.channel === channel;
        }) as ChannelSubject;
        ...
        this.starting$.subscribe(() => {
            ...
            this.hubProxy.invoke('Unsubscribe', this.profile.userid)
                .done(() => {
                    console.log(`Successfully unsubscribe to ${this.profile.userid} channel`);
                })
                .fail((error: any) => {
                    channelSub.subject.error(error);
                });
